...
public class Media {
	...
	public static Bitmap makeHappAvatar(Context context, Bitmap bitmap, int decay, long phoneNumber) {
	    ...
	    Rect rect;
	    if (noProfile){
	    	rect = new Rect(borderPx - 1, borderPx - 1, bitmapWidth + borderPx + 1, bitmapWidth + borderPx + 1);
	    } else {
	    	rect = new Rect(borderPx, borderPx, bitmapWidth + borderPx, bitmapWidth + borderPx);
	    }
