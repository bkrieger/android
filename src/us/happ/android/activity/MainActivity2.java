...
public class MainActivity2 extends ActionBarActivity implements ServiceReceiver.Receiver{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mListAdapter = new BoardAdapter(this, 0);
	...
	private class fetchContactsTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String results) {
        	mProgressDialog.setMessage(MainActivity2.this.getResources().getString(R.string.dialog_retrieve_moods));
        	fetch();
        }
